...
### Software
An INDI server with a collection of INDI device drivers - one of which is a Moonlite driver - runs on a Raspberry Pi 4B.  This is typically installed with the system **indi-bin** package. The Pico is attached via USB and was installed with the standard release of MicroPython as normal.  
